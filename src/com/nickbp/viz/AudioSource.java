...
public class AudioSource {
	...
	/**
	 * A utility class for directly forwarding audio data to a {@link DataListener}.
	...
	private static class PassthruListener implements Visualizer.OnDataCaptureListener {
		private final DataListener out;
		
		private PassthruListener(DataListener out) {
			this.out = out;
		}
	 ...
	 * {@link DataListener}, or does nothing if data is already being forwarded somewhere.
	 * Returns immediately once retrieval is set up.
	 * 
	 * @throws IllegalStateException if audio capture couldn't be enabled
	 */
	public void start(DataListener out) {
